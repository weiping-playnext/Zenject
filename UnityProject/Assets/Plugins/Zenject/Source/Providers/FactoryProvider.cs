...
namespace Zenject
{
    ...
    public class FactoryProvider<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9, TParam10, TValue, TFactory> : FactoryProviderBase<TValue, TFactory>
        where TFactory : IFactory<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9, TParam10, TValue>
    {
        public FactoryProvider(DiContainer container, List<TypeValuePair> factoryArgs)
            : base(container, factoryArgs)
        {
