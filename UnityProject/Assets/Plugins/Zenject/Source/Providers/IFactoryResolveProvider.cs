...
namespace Zenject
{
    ...
    public class IFactoryResolveProvider<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9, TParam10, TValue> : IProvider
    {
        readonly object _subIdentifier;
        readonly DiContainer _container;
            ...
            InjectContext context, List<TypeValuePair> args)
        {
            ...
            // Do this even when validating in case it has its own dependencies
            var factory = _container.ResolveId<IFactory<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9, TParam10, TValue>>(_subIdentifier);
