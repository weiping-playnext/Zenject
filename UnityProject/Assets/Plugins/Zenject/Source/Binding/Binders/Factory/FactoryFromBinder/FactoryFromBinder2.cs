...
namespace Zenject
{
    public class FactoryFromBinder<TParam1, TParam2, TContract> : FactoryFromBinderBase
    {
        ...
        public ArgConditionCopyNonLazyBinder FromMonoPoolableMemoryPool<TContractAgain>(
            ...
            // constraints below
            where TContractAgain : Component, IPoolable<TParam1, TParam2, IMemoryPool>
        {
        ...
        {
            return FromPoolableMemoryPoolInternal<TContractAgain, PoolableMemoryPool<TParam1, TParam2, IMemoryPool, TContractAgain>>(poolBindGenerator);
        }
