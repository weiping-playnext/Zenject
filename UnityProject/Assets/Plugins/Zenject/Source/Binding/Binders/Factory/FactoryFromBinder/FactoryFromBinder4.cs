...
namespace Zenject
{
    public class FactoryFromBinder<TParam1, TParam2, TParam3, TParam4, TContract> : FactoryFromBinderBase
    {
            ...
            where TContractAgain : IPoolable<TParam1, TParam2, TParam3, TParam4, IMemoryPool>
        {
            ...
            var binder = BindContainer.BindMemoryPoolCustomInterface<TContractAgain, PoolableMemoryPool<TParam1, TParam2, TParam3, TParam4, IMemoryPool, TContractAgain>, PoolableMemoryPool<TParam1, TParam2, TParam3, TParam4, IMemoryPool, TContractAgain>>(
                false,
            ...
            ProviderFunc =
                (container) => { return new PoolableMemoryPoolProvider<TParam1, TParam2, TParam3, TParam4, TContractAgain>(container, poolId); };
