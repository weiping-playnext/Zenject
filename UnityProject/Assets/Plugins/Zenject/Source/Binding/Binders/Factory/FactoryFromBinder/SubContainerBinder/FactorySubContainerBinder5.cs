...
namespace Zenject
{
        ...
        : FactorySubContainerBinderWithParams<TContract>
    {
        ...
        public NameTransformConditionCopyNonLazyBinder ByNewPrefabMethod(
            UnityEngine.Object prefab, Action<DiContainer, TParam1, TParam2, TParam3, TParam4, TParam5> installerMethod)
        {
        ...
        public NameTransformConditionCopyNonLazyBinder ByNewPrefabResourceMethod(
            string resourcePath, Action<DiContainer, TParam1, TParam2, TParam3, TParam4, TParam5> installerMethod)
        {
