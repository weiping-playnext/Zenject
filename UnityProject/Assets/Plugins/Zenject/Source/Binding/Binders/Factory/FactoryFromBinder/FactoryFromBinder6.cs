...
namespace Zenject
{
        ...
        : FactoryFromBinderBase
    {
        ...
        public ArgConditionCopyNonLazyBinder FromMonoPoolableMemoryPool<TContractAgain>(
            ...
            // constraints below
            where TContractAgain : Component, IPoolable<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, IMemoryPool>
        {
            return FromPoolableMemoryPoolInternal<TContractAgain, MonoPoolableMemoryPool<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, IMemoryPool, TContractAgain>>(poolBindGenerator);
        }
        ...
        {
            return FromPoolableMemoryPoolInternal<TContractAgain, PoolableMemoryPool<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, IMemoryPool, TContractAgain>>(poolBindGenerator);
        }
        ...
        ArgConditionCopyNonLazyBinder FromPoolableMemoryPoolInternal<TContractAgain, TMemoryPool>(
            ...
            // constraints below
            where TContractAgain : IPoolable<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, IMemoryPool>
            where TMemoryPool : MemoryPool<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, IMemoryPool, TContractAgain>
        {
            ...
            ProviderFunc =
                (container) => { return new PoolableMemoryPoolProvider<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TContractAgain, TMemoryPool>(container, poolId); };
