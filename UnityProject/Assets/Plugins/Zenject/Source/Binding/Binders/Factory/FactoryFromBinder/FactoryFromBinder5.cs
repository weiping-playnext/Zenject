...
namespace Zenject
{
        ...
        : FactoryFromBinderBase
    {
            ...
            where TContractAgain : IPoolable<TParam1, TParam2, TParam3, TParam4, TParam5, IMemoryPool>
        {
            ...
            var binder = BindContainer.BindMemoryPoolCustomInterface<TContractAgain, PoolableMemoryPool<TParam1, TParam2, TParam3, TParam4, TParam5, IMemoryPool, TContractAgain>, PoolableMemoryPool<TParam1, TParam2, TParam3, TParam4, TParam5, IMemoryPool, TContractAgain>>(
                false,
            ...
            ProviderFunc =
                (container) => { return new PoolableMemoryPoolProvider<TParam1, TParam2, TParam3, TParam4, TParam5, TContractAgain>(container, poolId); };
